  ...
  <main class="shell">
    ...
    <aside class="workspace">
      ...
      <section>
        ...
        <button class="wide alt" data-prompt="用 Tree of Thoughts 深度研究：Cloudflare Vectorize 在 RAG 应用中的优缺点，并展示候选思路评分">TOT 研究演示</button>
      </section>
    </aside>
  </main>
